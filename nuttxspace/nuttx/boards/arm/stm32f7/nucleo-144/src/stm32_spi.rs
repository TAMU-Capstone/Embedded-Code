...
mod stm32_spi {
  ...
  ****************************************************************************/
    ...
    static mut SPI1: Option<NonNull<spi_dev_s>> = None;

    #[cfg(all(CONFIG_STM32F7_SPI2, CONFIG_NUCLEO_SPI_TEST))]
    static mut SPI2: Option<NonNull<spi_dev_s>> = None;
    
    #[cfg(all(CONFIG_STM32F7_SPI3, CONFIG_NUCLEO_SPI_TEST))]
    static mut SPI3: Option<NonNull<spi_dev_s>> = None;
